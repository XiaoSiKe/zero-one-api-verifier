...
FAQ_CATEGORIES: tuple[FAQCategory, ...] = (
    FAQCategory(
        ...
        entries=(
            ...
            FAQEntry(
                ...
                "甚至注入额外 system prompt。零一智鉴检测的就是这种「中间到底动了什么」。",
            ),
            FAQEntry(
                "relay-legal",
                "中转站合法吗?用了会不会出问题?",
            ...
            FAQEntry(
                "relay-steal-key",
                "用中转站的 API key 有什么风险?",
                "零一智鉴实测过很多家中转站,常见的坑有 5 种(都见过真实案例):"
                ...
                "你真去用其中一些,直接报「没有这个模型」。零一智鉴在你提交检测前会先帮你"
    ...
    FAQCategory(
        ...
        entries=(
            ...
            FAQEntry(
                ...
                "基本可以判定中转站在做协议转换。零一智鉴把这种指纹标记为 critical 级别。",
            ),
        ),
    ),
    FAQCategory(
        ...
        entries=(
            ...
            FAQEntry(
                "claude-code-relay",
                "Claude code 中转站怎么挑?",
                "关键看 4 点:① 跑一次零一智鉴看 thinking signature 是否拿到 100 分;"
            ...
            FAQEntry(
                ...
                "零一智鉴的 thinking_signature detector 已经针对这个切到非流式,确保检测可靠。",
            ),
            FAQEntry(
                "claude-cost",
                ...
                "Opus ~$0.20。零一智鉴自己不收费 — 你付的是上游 API 的真实 token 钱。",
            ),
            FAQEntry(
                "claude-zero-score",
                "检测出 0 分是不是这家中转站完全没用?",
    ...
    FAQCategory(
        ...
        entries=(
            ...
            FAQEntry(
                ...
                "(尤其 protocol detector 报多个 critical),零一智鉴会把 verdict 砍到 marginal — "
            ...
            FAQEntry(
                ...
                "零一智鉴的预探测会列出该 key 在中转站上有多少模型属于本协议。"
    ...
    FAQCategory(
        ...
        intro=(
            "零一智鉴的 Gemini 检测只走 OpenAI 兼容路径(POST /chat/completions),"
        ...
        entries=(
            FAQEntry(
                ...
                "零一智鉴提交前会做 preflight,500ms 内识别死模型并给出可用列表替代。",
            ),
            FAQEntry(
    ...
    FAQCategory(
        ...
        entries=(
            FAQEntry(
                "how-to-use",
                "零一智鉴怎么用?最简流程?",
                "三步:① 打开 mix.01yapi.cc/claude(或 /openai、/gemini);"
            ...
            FAQEntry(
                "self-host",
                "可以本地自托管零一智鉴吗?",
                "可以,零一智鉴完全开源。clone 仓库 → pip install -e .[web] → "
    ...
    FAQCategory(
        ...
        title="隐私与安全",
        intro=(
            "把 API key 交给一个检测工具是有风险的事,所以零一智鉴在数据处理上的承诺需要"
        ...
        entries=(
            ...
            FAQEntry(
                ...
                "cctest.ai 也声称不上传 key,但代码闭源无法验证。零一智鉴完全开源,"
    ...
    FAQCategory(
        ...
        title="工具对比",
        intro=(
            "中转站检测领域不止零一智鉴一家,这一组讲清楚零一智鉴跟同类工具的差异、"
            "以及怎么挑中转站。"
        ),
        entries=(
            FAQEntry(
            ...
            FAQEntry(
                "vs-leaderboards",
                "中转站对比榜单(aiapipk.com / 知乎评测)跟零一智鉴是什么关系?",
                "那些是「主观评测」或「广告导向」,零一智鉴是「客观技术检测」。"
                "可以互补:用榜单初筛信誉好的中转站,再用零一智鉴做技术验证。",
            ),
            FAQEntry(
                "how-to-pick-relay",
                "怎么挑中转站?有什么硬性指标?",
