...
> - 下游仓库：`XiaoSiKe/zero-one-api-verifier`
...
| 正式域名 | `https://mix.01yapi.cc` |
| Canonical 基址 | `https://mix.01yapi.cc` |
| 仓库 | `XiaoSiKe/zero-one-api-verifier` |
...
- 模板声明的 Canonical 使用 `https://mix.01yapi.cc`，且不回退到 `veridrop.org`；
